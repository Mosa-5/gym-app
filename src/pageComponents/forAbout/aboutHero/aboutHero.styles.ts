...
export const banner = cva(
  "relative bg-black text-white h-[50vh] md:h-[60vh] 2xl:h-[65vh] flex items-end pb-16 md:pb-20 2xl:pb-28",
);
...
export const heading = cva(
  "text-3xl sm:text-5xl md:text-6xl lg:text-7xl 2xl:text-[100px] font-black uppercase leading-[0.9] ka:leading-[1.2] ka:lg:text-6xl tracking-tight py-1",
);
export const paragraph = cva(
  "mt-4 text-sm md:text-base 2xl:text-lg ka:md:text-sm italic text-neutral-400 max-w-lg 2xl:max-w-xl ka:max-w-xl",
);
