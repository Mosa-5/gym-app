    ...
    >
      {isLoading ? (
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <span className="text-sm text-neutral-400">Failed to load products.</span>
        </div>
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-5">
          ...
          >
            ...
            />
            <img src={noDataSVG} alt="" className="relative w-28 h-28 object-contain" />
          </div>
          <p className="text-sm text-neutral-400">No products match your filters.</p>
        </div>
      ) : (
    <>
      {/* Product grid */}
