...
export const subtitleClass = cva(
  "text-sm sm:text-lg md:text-2xl 2xl:text-3xl font-semibold uppercase tracking-[0.25em] text-neutral-300",
);
...
export const paragraphClass = cva(
  "mt-3 sm:mt-6 text-sm md:text-base 2xl:text-lg ka:md:text-sm leading-relaxed text-neutral-400 max-w-xs sm:max-w-sm 2xl:max-w-md ka:max-w-md mx-auto sm:mx-0",
);
