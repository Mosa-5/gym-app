...
export const heading = cva([
  "text-brand-on-dark text-3xl md:text-4xl 2xl:text-6xl",
  "font-bold tracking-wider",
]);
export const saleText = cva([
  "text-xl md:text-2xl 2xl:text-3xl",
  "font-medium mt-2 tracking-wide",
]);
export const button = cva([
  "mt-4 px-8 py-6 2xl:px-12 2xl:py-8 rounded-full",
  "2xl:text-lg text-white font-bold",
]);
