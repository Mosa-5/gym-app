...
export const wrapper = cva([
  "relative flex flex-col gap-7 justify-center items-center",
  "py-10 sm:py-20 lg:py-24 2xl:py-32 overflow-hidden",
]);
...
export const carouselItem = cva([
  "md:basis-1/2 lg:basis-1/3 py-4",
  "flex justify-center transition-all duration-300",
]);

export const image = cva([
  "h-64 object-contain mb-2 rounded-full",
  "border-2 border-spacing-1 border-black shadow-sm",
