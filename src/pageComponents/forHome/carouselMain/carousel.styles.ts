...
export const carousel = cva(
  "w-[97%] sm:w-[85%] lg:w-[80%] 2xl:w-[90%] max-w-5xl 2xl:max-w-[1560px]",
);

export const carouselItem = cva(
  "basis-[56%] sm:basis-1/2 lg:basis-1/3 2xl:basis-1/4 pl-0 sm:pl-4 py-4",
);
...
export const cardContent = cva(
  "flex flex-col gap-2 lg:gap-3 items-center p-4 pb-5 sm:pb-6 2xl:p-6 2xl:pb-8",
);

export const image = cva(
  "h-36 sm:h-40 lg:h-56 2xl:h-72 object-contain mb-5 sm:mb-6 lg:mb-10 rounded-full",
);
