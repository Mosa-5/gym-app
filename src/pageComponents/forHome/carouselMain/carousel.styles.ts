...
export const carousel = cva("w-[70%] sm:w-[85%] lg:w-[80%] 2xl:w-[90%] max-w-5xl 2xl:max-w-[1560px]");
...
export const cardContent = cva("flex flex-col gap-5 items-center p-4 pb-6 2xl:p-6 2xl:pb-8");
