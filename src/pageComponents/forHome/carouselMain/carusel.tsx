...
const CaruselForPages: React.FC<CarouselProps> = ({
  ...
  const handleAddToCart = (e: React.MouseEvent, product: ReturnType<typeof mapProductTableData>[number]) => {
    e.preventDefault();
    e.stopPropagation();
    addToCart({
      id: product.id,
