...
export const triggerClass = cva([
  ...
  "bg-neutral-800/80 hover:bg-neutral-700 transition-colors duration-200",
]);

export const badgeClass = cva([
  "absolute -top-0.5 -right-0.5 flex justify-center items-center",
  "rounded-full font-bold leading-none",
  "bg-brand text-white text-[10px] 2xl:text-[11px]",
  "w-4 h-4 2xl:w-5 2xl:h-5",
]);

export const sheetContentClass = cva([
  "w-full max-w-full sm:max-w-md 2xl:max-w-lg",
...
export const itemCardClass = cva([
  "flex gap-4 2xl:gap-5 p-3 2xl:p-4",
  "rounded-xl bg-neutral-900 border border-neutral-800",
]);

export const itemImageClass = cva([
  "w-20 h-20 sm:w-16 sm:h-16 2xl:w-24 2xl:h-24",
  "rounded-lg overflow-hidden bg-neutral-800 flex-shrink-0",
]);

export const itemNameClass = cva([
  "text-base sm:text-sm 2xl:text-base font-semibold",
  "text-white truncate",
]);
...
export const qtyButtonClass = cva([
  ...
  "w-8 h-8 sm:w-6 sm:h-6 2xl:w-8 2xl:h-8",
...
export const subtotalLabelClass = cva([
  "text-sm 2xl:text-base text-neutral-400",
...
export const checkoutButtonClass = cva([
  ...
  "text-sm 2xl:text-base py-3.5 2xl:py-4 transition-colors duration-200",
]);
